...
mod tests {
    ...
    fn test_unix() {
        ...
        assert!(s2
            .servers
            .contains(&IpAddr::from_str("45.90.28.55").unwrap()));
        assert!(s2
            .servers
            .contains(&IpAddr::from_str("45.90.30.55").unwrap()));
        assert!(s2
            .servers
            .contains(&IpAddr::from_str("2a07:a8c0::").unwrap()));
        assert!(s2
            .servers
            .contains(&IpAddr::from_str("2a07:a8c1::").unwrap()));
    ...
    fn test_windows() {
        let s1 = Resolver::get_servers(None);
        assert!(s1.is_ok());
